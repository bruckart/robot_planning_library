...
DeathStarItem::DeathStarItem(int x, int y, double r)
:
...
double DeathStarItem::radius() const
{
    return m_radius;
}

QRectF DeathStarItem::boundingRect() const
{
    return QRectF(m_x, m_y, m_radius*2, m_radius*2);
}

QPainterPath DeathStarItem::shape() const
{
    QPainterPath path;
...
void DeathStarItem::paint(QPainter* painter, 
